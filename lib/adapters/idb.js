...
function init(api, opts, callback) {
  ...
  // migrations to get to version 5
  // we used to figure out metadata.winningRev and metadata.seq
  // on-the-fly if it wasn't there, but it's cleaner to just
  // migrate everything
